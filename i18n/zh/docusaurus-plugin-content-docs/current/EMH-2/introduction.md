...
- 符合ETSI EN 303 645，采取安全措施保护数据及用户个人信息和隐私
...
| 输入特性 | 最小   | 额定值        | 最大   |
| -------- | ------ | ------------- | ------ |
| 输入电压 | 100Vac | 100Vac~240Vac | 240Vac |
| 输入频率 | 47Hz   | 60Hz/50Hz     | 50Hz   |

 
| 输出特性       | 额定负载  | 输出电压范围 | 纹波与噪声 |
| -------------- | --------- | ------------ | ---------- |
| Rate Min. Load | Max. Load | +5V          |            |
| 0.1A           | 2A        | 4.65V~5.35V  | 200mVp-p   |
